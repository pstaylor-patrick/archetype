...
from archetype.scoring import rank_concepts, score_color
...
def print_tradeoff_matrix(
    ...
    scored_concepts = rank_concepts(study.concepts, analysis)
    ...
    console.print(Panel(study.recommendation, title="Recommendation", border_style="green"))
